...
Create a main.py file in the calculator directory and copy-paste this code:
...
Create a tests.py file in the calculator directory and copy-paste this code:
...
Create a calculator.py file in the calculator/pkg subdirectory and copy-paste this code:
...
Create a render.py file in the calculator/pkg subdirectory and copy-paste this code:
